...
export const offers: OfferType[] = [
  ...
  },
  {
    ...
    description: 'Verona-1: A quiet cozy and picturesque that hides behind a river by the unique lightness of Amsterdam.',
    goods: ['Dishwasher'],
    host: {
      avatarUrl: 'img/avatar.svg',
      id: 6,
    ...
    price: 150,
    rating: 4.8,
    title: 'Verona-1: Beautiful & luxurious studio at great location',
    type: 'hotel',
  },
];
